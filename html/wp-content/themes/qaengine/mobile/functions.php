	        ...
	        <div class="row">
	        	<div class="col-md-12">
	               <div class="tabs-title">
	                	<ul>
	                		<li><span class="title-bar-tab active" id="tab-question"><?php _e('Ask question', ET_DOMAIN);?></span></li>
	                		<li><span class="title-bar-tab" id="tab-poll"><?php _e('Create poll', ET_DOMAIN);?></span></li>
	                	</ul>
	                </div>
